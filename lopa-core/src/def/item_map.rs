...
impl std::ops::Index<TypeExprId> for ItemMap {
...
impl std::ops::Index<ItemTypeExprId> for ItemMap {
    type Output = parsing::NodeId;
...
impl std::ops::Index<ElemId> for ItemMap {
    type Output = parsing::NodeId;
...
impl std::ops::Index<PatId> for ItemMap {
    type Output = parsing::NodeId;
